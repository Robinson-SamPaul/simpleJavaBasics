...
public class AdiObjectOutputStream {

	public static void main(String[] args) throws IOException {

		/*
		 * Supports all the primitive data types as the DataOutputStream, Also supports
		...
		try (ObjectInputStream objIn = new ObjectInputStream(
			...
			for (int i = 0; i < names.length; i++) {
				...
				BigInteger id = (BigInteger) objIn.readObject();
